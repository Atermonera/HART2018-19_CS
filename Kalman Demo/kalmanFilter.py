...
class velocityKalman:
    ...
    def newMeasurement(self, pressure, pressureUncertainty, velocity, velocityUncertainty, acceleration):
        ...
        kalmanGain_mat = np.nan_to_num(kalmanGain_mat)
    ...
    def getCurrentVelocity(self):
        return self.currentState_mat.flat[1]

    def getCurrentVelocityUncertainty(self):
        return self.pc_mat.flat[3]

    def getCurrentPressure(self):
        return self.currentState_mat.flat[0]

    def getCurrentPressureUncertainty(self):
        return self.pc_mat.flat[0]