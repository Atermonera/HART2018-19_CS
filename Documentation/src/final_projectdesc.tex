...
\begin{titlepage}
    ...
    \begin{singlespace}
		...
		To that end we identify three main problems and their associated solutions: the processing of in-flight data from previous years, the capture of in-flight telemetry from our rockets and tests, and the meaningful interpretation and visualization of the data we capture, with the capture of telemetry being the most mission critical.
