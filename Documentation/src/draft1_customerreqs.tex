		...
		\begin{figure}
			\begin{center}
				...
				\begin{ganttchart}[
					...
					\\
					%Week
					\gantttitlelist{19,24,01,08,15,22,29,05,12,19,26,03,10,17,24,31,07,14,21,28,
									04,11,18,25,04,11,18,25,01,08,15,22,29,06,13,20,27,03,10,17,22}{7} \\
					%tasks
					%\ganttbar{Name}{Start}{End} \\
					% Calculate dates from 10 Sep 2018, give in number of days
					% Design
					\ganttbar{Problem Statement}{28}{39} \\
					\ganttbar{Customer Requirements}{43}{81} \\
					\ganttbar{Tech Review, Draft 1}{50}{53} \\
					\ganttbar{Tech Review}{55}{81} \\
					\ganttbar{Team Standards}{50}{57} \\
					\ganttbar{Design Document}{64}{78} \\
					\ganttbar{Tech Research and Development}{63}{88} \\
					% Implementation
					\ganttbar{FR1: Acceleration Display}{113}{143} \\
					\ganttbar{FR2: Altitude Display}{113}{143} \\
					\ganttbar{FR3: Barometric Pressure Display}{144}{174} \\
					\ganttbar{FR5: Thrust Interpretation}{144}{174} \\
					\ganttbar{FR5: Thrust Display}{159}{189} \\
					\ganttbar{FR6: Velocity Interpretation}{113}{143} \\
					\ganttbar{FR7: Velocity Display}{128}{158} \\
					\ganttbar{FR8: Flight Path and Location Display}{175}{205} \\
					\ganttbar{FR9: Data Storage}{113}{143} \\
					\ganttbar{QR1: Telemetry Reception}{144}{174} \\
					\ganttbar{QR2: Real-time Visualization}{175}{205} \\
					\ganttbar{QR3: Interactive Visualization}{144}{174} \\
					\ganttbar{QR4: Data Accessibility}{113}{273} \\
					\ganttbar{Testing}{113}{273} \\
					% Presentation
					\ganttbar{EXPO}{255}{256} \\
					\ganttbar{Spaceport America Cup: Presentation}{282}{283} \\
					\ganttbar{Spaceport America Cup: Flight}{283}{285} \\
				\end{ganttchart}
			\end{center}
			\caption{Gantt Chart}
		\end{figure}
